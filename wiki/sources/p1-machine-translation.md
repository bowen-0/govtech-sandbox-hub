...
Published February 2024. Original filename: `maschine_translation_kzh_sandbox_report.pdf`.

## Use as citation

Authoritative source for:
- Swiss legal stack applied to AI-in-administrative-procedure use cases (FADP Art. 21 + Art. 29 BV automated-decision framing).
